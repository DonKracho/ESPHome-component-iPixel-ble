![Made for ESPHome]([https://esphome.io/guides/images/made-for-esphome-black-on-white.svg](https://raw.githubusercontent.com/DonKracho/ESPHome-configurations/06cc01772bdb5ab3a25a72783a457e18d9daf7df/made-for-esphome-black-on-white.svg))
...
- **Known issues:**  
  - The code is tested with display size 32x32 and 96x16 only. The size is captued from the device. If the size recognition fails the width and height parameters can be set in ipixel_ESP-xyz.yaml display section.

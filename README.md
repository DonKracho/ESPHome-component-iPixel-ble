...
- **Known issues:**  
  - tested with display size 32x32 and 18x96 only. The size is captued from the device. If the size recognition fails the width and height parameters can be set in ipixel_ble.yaml display section.
